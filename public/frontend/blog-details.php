...
<title>Web Digital - место для интернет маркетинга и рекламы и бизнеса</title>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="author" content="Web Digital">
<meta name="description" content="Узнайте о последних изменениях в маркетинговой среде или получите подробные инструкции по повышению эффективности в нашем блоге.">
...
<!-- End Google Tag Manager (noscript) -->
	...
	<header class="header">
		<div class="header_content d-flex flex-row align-items-center justify-content-center">
            ...
            <p class="tel_uz_768 ml-auto"><i class="fa fa-phone"></i></p>
		</div>
	</header>
			...
			<nav class="menu_nav">
				<ul>
                    ...
                    <li id="menu_2_none_chiq" class="menu_2_none">
                        <ul>
                            <li><a href="website.php">Сайт</a></li>
					...
					<li><a href="portfoli.php">Портфолио</a></li>
...
function get_post_by_id($post_id){
 ...
 ?>
<div style="position: absolute; width: 100%; top: 100%; background-color: white; padding-top: 100px;">
        <main class="container">
                <div class="blog-details">
                    <article class="post-details" id="post-details">
                        <header class="wow fadeInUp bog-header text-center">
                            <h3><span><?=$post['sana'] ?></span> <?=$post['oy'] ?> <?=$post['yil'] ?></h3>
                            <h2> <?=$post['title'] ?></h2>
                        </header>
                        <figure class="wow fadeInUp ">
                            <img style="width: 100%;" src="images/blog/<?=$post['web_img'] ?>.jpg" alt="<?=$post['title'] ?>" class="img-responsive"/>
                        </figure>
                        <div class="wow fadeInUp  enter-content">
                            <p> <?=$post['web_post'] ?> </p>
                        </div>
                    </article>
                </div>
