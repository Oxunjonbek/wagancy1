...
<title>{{Lang::get('blog.webdigital')}}</title>
...
<link rel="icon" type="image/x-icon" href="{{asset('frontend/images/logo/favicon.ico')}}">
<!-- icon -->
		...
		<div class="header_content d-flex flex-row align-items-center justify-content-center">
			...
			<nav class="main_nav" style="position: relative; left: 105px; margin-right: 45px;">
				<ul class="d-flex flex-row align-items-start justify-content-start">
					...
					<li class="active"><a href="{{ route('blog') }}">{{Lang::get('home.menu4')}}</a></li>
...
function get_post_by_id($post_id){
  ...
  $post = App\Blog::where('id',$post_id)->first();
    return $post;}
                ...
                <div class="blog-details">
                    <article class="post-details" id="post-details">
                        ...
                        <header class="wow fadeInUp bog-header text-center">
                            <h3><span><?=$post->created_at->format('d/m/Y');?></span></h3>
                            <h2> <?=$post['title'] ?></h2>
                            </header>
                        <figure class="wow fadeInUp ">
                            <img style="width: 100%;" src="{{asset('frontend/images/blog')}}/<?=$post['web_img'] ?>" alt="<?=$post['title'] ?>" class="img-responsive"/>
                        </figure>
