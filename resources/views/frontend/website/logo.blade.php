...
<title>{{Lang::get('website.uslugubrand')}}</title>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="author" content="Web Digital">
<meta name="description" content="Web Digital | брендинговое агентство с полным спектром услуг, которая помогает компаниям подчеркнуть свои сильные стороны, укрепить свой голос и поднять свой бренд.">
<meta name="keywords" content="логотип, айдентика, фирменный стиль, бизнес, бренд, брендинг, эмблема, марка, торговая марка, Ташкент, Узбекистан">
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    },
    {
      ...
      "price": "39.00",
      "priceCurrency": "USD",
      "url": "https://www.logo.wdagency.com"
    }
  ]
}
</script>
...
<div style="position: absolute; width: 100%; height: 100%;">
		...
		<div class="header_content d-flex flex-row align-items-center justify-content-center">
			<div class="logo_container d-flex flex-row align-items-center justify-content-start">
				<div class="wow fadeInLeft logo">
                  <a href="{{ route('/') }}"><img src="{{asset('frontend/images/logo/1.png')}}" alt="WD | Web Digital"></a>
				</div>
				<div class="wow fadeInLeft logo_text" style="text-transform: uppercase; line-height: 1.5em; font-weight: bold; font-size: 20px; top: 3px;">
					...
					<span style="float: left; color: red; letter-spacing: 1px;">&nbsp;{{Lang::get('home.agenstvo')}}</span>
				</div>
			...
			<p class="tel_uz_768 ml-auto"><a href="tel:+998933566661"><i class="fa fa-phone"></i></a></p>
				...
				<div class="menu_2 header1">
					<ul>
						<li class="wow flipInX menu_2_li"><a href="{{ route('website') }}"><h5>{{Lang::get('home.uslugu1')}}</h5></a></li> 
						<li class="wow flipInX activte"><a href="{{ route('logo') }}"><h5>{{Lang::get('home.uslugu2')}}</h5></a></li>
	...
	<div class="menu trans_400 d-flex flex-column align-items-start justify-content-center">
		...
		<div class="menu_content">
			<nav class="menu_nav">
				<ul>
					<li><a href="{{ route('/') }}">{{Lang::get('home.menu1')}}</a></li>
					...
					<li id="menu_2_none_chiq" class="menu_2_none">
						<ul>
							<li><a href="{{ route('website') }}">{{Lang::get('home.uslugu1')}}Сайт</a></li>
...
<div style="position: absolute; width: 100%; top: 100%;">
			...
			<div class="row row-eq-height text-center">
				<div class="col-xl-12 order-xl-2 order-1">
					<div class="wow fadeInUp intro_content">
						<h1>
								<span class="intro_title">{{Lang::get('website.brending')}}<span>.</span></span>
								<label class="intro_text">
									{{Lang::get('website.brendinglejit')}}
								  
								<br>
								<br>
								{{Lang::get('website.inogdadlya')}}
	...
	<div class="week_model" style="padding-top: 0px;">
		<div class="wow fadeInRight section_title_container d-flex flex-row align-items-center justify-content-end">
			<div class="d-flex flex-row align-items-center justify-content-start">
				<div class="section_title"><h2>{{Lang::get('website.aydenti')}}<span>.</span></h2></div>
			</div>
		</div>
		<div class="container">
			<div class="row row-eq-height">
				<div class="col-xl-5 col-lg-6 order-lg-1 order-2 model_col">
					<div class="model_slider_container">
						<div class="wow fadeInRight owl-carousel owl-theme model_slider">
							<picture>
								<img src="{{asset('frontend/images/logo-page/10.jpg')}}" alt="Logo | фирменный дизайн">
							</picture>
						</div>
					</div>
				</div>
				<div class="wow fadeInLeft col-lg-6 offset-xl-1 order-lg-2 order-1 padding-top">
					<div class="week_model_content">
						<h3 class="week_model_title">{{Lang::get('website.logotipfirm')}}</h3>
						<div class="week_model_text">
							<h4>
								&nbsp;&nbsp;&nbsp;&nbsp;{{Lang::get('website.prosessrazr')}} 
							</h4>
							<h4>
								&nbsp;&nbsp;&nbsp;&nbsp;{{Lang::get('website.proishoditobr')}}  
							</h4>
							<p>&nbsp;</p>
							<p>&nbsp;</p>
						</div>
	...
	<div class="week_model">
		<div class="wow fadeInLeft section_title_container d-flex flex-row align-items-center">
			<div class="d-flex flex-row align-items-center justify-content-start">
				<div class="section_title" style="margin-left: auto;"><h2>{{Lang::get('website.brending')}}<span>.</span></h2></div>
			</div>
		</div>
		<div class="container">
			<div class="row row-eq-height">
				<div class="wow fadeInRight col-lg-6 order-lg-1 order-2 padding_bottom">
					<div class="week_model_content left_uz width_uz">
						<h3 class="week_model_title">{{Lang::get('website.neyming')}}</h3>
						<div class="week_model_text">
							<h4>&nbsp;&nbsp;&nbsp;&nbsp;{{Lang::get('website.odnimiz')}}
							</h4>
							<h4>
								&nbsp;&nbsp;&nbsp;&nbsp;{{Lang::get('website.vvizualizasiyu')}}
							</h4>
						</div>
					</div>
				</div>
				<div class="col-xl-5 col-lg-6 order-lg-2 order-1 model_col">
					<div class="model_slider_container_right">
						<div class="wow fadeInLeft owl-carousel owl-theme model_slider">
							<picture>
								<img src="{{asset('frontend/images/logo-page/14.jpg')}}" alt="Logo | визуализация бренда">
							</picture>
						</div>
					</div>
				</div>
	...
	<div class="week_model">
		<div class="wow fadeInRight section_title_container d-flex flex-row align-items-center justify-content-end">
			<div class="d-flex flex-row align-items-center justify-content-start">
				<div class="section_title"><h2>{{Lang::get('website.logomaniya')}}<span>.</span></h2></div>
			</div>
		</div>
		<div class="container">
			<div class="row row-eq-height">
				<div class="col-xl-5 col-lg-6 order-lg-1 order-2 model_col">
					<div class="model_slider_container">
						<div class="wow fadeInRight owl-carousel owl-theme model_slider">
							<picture>
								<img src="{{asset('frontend/images/logo-page/11.jpg')}}" alt="Logo | философия бренда">
							</picture>
						</div>
					</div>
				</div>
				<div class="wow fadeInLeft col-lg-6 offset-xl-1 order-lg-2 order-1 padding-top">
					<div class="week_model_content">
						<h3 class="week_model_title">{{Lang::get('website.rukovodstvo')}}</h3>
						<div class="week_model_text">
							<h4>
								&nbsp;&nbsp;&nbsp;&nbsp;{{Lang::get('website.zaversha')}}

							</h4>
							<h4>
								&nbsp;&nbsp;&nbsp;&nbsp;{{Lang::get('website.vibor')}}
							</h4>
						</div>
					</div>
				</div>
	...
	<div class="week_model">
		<div class="wow fadeInLeft section_title_container d-flex flex-row align-items-center">
			<div class="d-flex flex-row align-items-center justify-content-start">
				<div class="section_title" style="margin-left: auto;"><h2>{{Lang::get('website.brendgid')}}<span>.</span></h2></div>
			</div>
		</div>
		<div class="container">
			<div class="row row-eq-height">
				<div class="wow fadeInRight col-lg-6 order-lg-1 order-2 padding_bottom">
					<div class="week_model_content left_uz width_uz">
						<h3 class="week_model_title">{{Lang::get('website.osvedom')}}</h3>
						<div class="week_model_text">
							<h4>&nbsp;&nbsp;&nbsp;&nbsp;{{Lang::get('website.miraz')}}
							</h4>
							<h4>
								&nbsp;&nbsp;&nbsp;&nbsp;{{Lang::get('website.syudav')}}
							</h4>
						</div>
					</div>
				</div>
				<div class="col-xl-5 col-lg-6 order-lg-2 order-1 model_col">
					<div class="model_slider_container_right">
						<div class="wow fadeInLeft owl-carousel owl-theme model_slider">
							<picture>
								<img src="{{asset('frontend/images/logo-page/12.jpg')}}" alt="Logo | стратегия брендинга">
							</picture>
						</div>
					</div>
				</div>
	...
	<div class="week_model">
		<div class="wow fadeInRight section_title_container d-flex flex-row align-items-center justify-content-end">
			<div class="d-flex flex-row align-items-center justify-content-start">
				<div class="section_title"><h2>{{Lang::get('website.sena')}}<span>.</span></h2></div>
			</div>
		</div>
		<div class="container">
			<div class="row row-eq-height">
				<div class="wow fadeInRight col-xl-5 col-lg-6 order-lg-1 order-2 model_col">
					<div class="model_slider_container">
						<div class="owl-carousel owl-theme model_slider">
							<picture>
								<img src="{{asset('frontend/images/logo-page/13.jpg')}}" alt="Logo | бренд прайс">
							</picture>
						</div>
					</div>
				</div>
				<div class="wow fadeInLeft col-lg-6 offset-xl-1 order-lg-2 order-1 padding-top">
					<div class="week_model_content">
						<h3 class="week_model_title">{{Lang::get('website.brend')}}</h3>
						<div class="week_model_text">
							<table class="table">
								<tbody>
									<tr>
										<th>{{Lang::get('home.menu2')}}</th>
										<th>{{Lang::get('website.srokdney')}}</th>
										<th>{{Lang::get('website.sena')}}</th>
									</tr>
									<tr>
										<td>{{Lang::get('website.neyming')}}</td>
										<td>3</td>
										<td>10 у.е</td>
									</tr>
									<tr>
										<td>{{Lang::get('website.logotipa')}}</td>
										<td>5</td>
										<td>39 у.е</td>
									</tr>
									<tr>
										<td>{{Lang::get('website.brendbuk')}}</td>
										<td>7</td>
										<td>60 у.е</td>
									</tr>
									<tr>
										<td>{{Lang::get('website.razboka')}}</td>
										<td>10</td>
										<td>90 у.е</td>
									</tr>
									<tr>
										<td>{{Lang::get('website.marketingkit')}}</td>
										<td>3</td>
										<td>100 у.е</td>
									</tr>
								</tbody>
...
<script src="{{asset('plugins/Isotope/packery-mode.pkgd.min.js')}}"></script>
<script src="{{asset('plugins/Isotope/fitcolumns.js')}}"></script>
<script src="{{asset('plugins/Isotope/masonry-horizontal.js')}}"></script>
<script src="{{asset('plugins/progressbar/progressbar.min.js')}}"></script>
<script src="{{asset('plugins/parallax-js-master/parallax.min.js')}}"></script>
<script src="{{asset('js/custom.js')}}"></script>
<script src="{{asset('js/usluga.js')}}"></script>
<script src="{{asset('js_uz/animated-headline.js')}}"></script>
<script src="{{asset('https://cdnjs.cloudflare.com/ajax/libs/wow/1.1.2/wow.min.js')}}"></script>
<script src="{{asset('js/index.js')}}"></script>
    <!--  custom script -->
 <script src="{{asset('js_uz/custom.js')}}"></script>
</body>
</html>