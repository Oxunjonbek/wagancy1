...
<title>{{Lang::get('website.kontekstnaya')}}</title>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="author" content="Web Digital">
<meta name="description" content="Если вы ищете контекстную рекламу, вы попали по адресу! Web Digital - идеальное агентство для управления PPC, и на этой странице мы поговорим об управление Google Ads и Яндекс Директ.">
<meta name="keywords" content="google ads, google adwords, yandex direct, яндекс директ, контекстная реклама, ppc, реклама в google, реклама в яндексе, Ташкент, Узбекистан">
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    },
    {
      ...
      "price": "100.00",
      "priceCurrency": "USD",
      "url": "https://www.google.wdagency.com"
    }
  ]
}
</script>
			...
			<p class="tel_uz_768 ml-auto"><a href="tel:+998933566661"><i class="fa fa-phone"></i></a></p>
				...
				<div class="menu_2 header1">
					<ul>
						...
						<li class="wow flipInX activte"><a href="{{ route('ppc') }}"><h5>ppc</h5></a></li>
...
<div style="position: absolute; width: 100%; top: 100%;">
			...
			<div class="row row-eq-height text-center">
				<div class="col-xl-12 order-xl-2 order-1">
					<div class="wow fadeInUp intro_content">
						<h1>
								<span class="intro_title">{{Lang::get('website.kontekstnayarek')}}<span>.</span></span>
								<label class="intro_text">{{Lang::get('website.internetreklama')}}
								
								<br>
								<br>
								{{Lang::get('website.nashimenedjer')}}
	...
	<div class="week_model" style="padding-top: 0px;">
		<div class="wow fadeInRight section_title_container d-flex flex-row align-items-center justify-content-end">
			<div class="d-flex flex-row align-items-center justify-content-start">
				<div class="section_title"><h2>{{Lang::get('website.ppcp')}}<span>.</span></h2></div>
			</div>
		</div>
		<div class="container">
			<div class="row row-eq-height">
				<div class="col-xl-5 col-lg-6 order-lg-1 order-2 model_col">
					<div class="model_slider_container">
						<div class="wow fadeInRight owl-carousel owl-theme model_slider">
							<picture>
								<source src="images/pcc/10.jpg" type="image/webp">
								<img src="{{asset('frontend/images/pcc/10.jpg')}}" alt="PCC | google и yandex">
							</picture>
						</div>
					</div>
				</div>
				<div class="wow fadeInLeft col-lg-6 offset-xl-1 order-lg-2 order-1 padding-top">
					<div class="week_model_content">
						<h3 class="week_model_title">{{Lang::get('website.razrjayte')}}</h3>
						<div class="week_model_text">
							<h4>
								&nbsp;&nbsp;&nbsp;&nbsp;{{Lang::get('website.konteksttakje')}} 
							</h4>
							<h4>
								&nbsp;&nbsp;&nbsp;&nbsp;{{Lang::get('website.umnoyuprav')}}  
							</h4>
							<h4>
								&nbsp;&nbsp;&nbsp;&nbsp;{{Lang::get('website.dlyauspeshnoy')}}
							</h4>
							<p>&nbsp;</p>
						</div>
					</div>
	...
	<div class="week_model">
		<div class="wow fadeInLeft section_title_container d-flex flex-row align-items-center">
			<div class="d-flex flex-row align-items-center justify-content-start">
				<div class="section_title" style="margin-left: auto;"><h2>{{Lang::get('website.sifrppc')}}<span>.</span></h2></div>
			</div>
		</div>
		<div class="container">
			<div class="row row-eq-height">
				...
				<div class="wow fadeInRight col-lg-6 order-lg-1 order-2 padding_bottom">
					<div class="week_model_content left_uz width_uz">
						<h3 class="week_model_title">{{Lang::get('website.fsesifr')}} </h3>
						<div class="week_model_text">
							<h4>&nbsp;&nbsp;&nbsp;&nbsp;{{Lang::get('website.imeya')}}
							</h4>
							<h4>
								&nbsp;&nbsp;&nbsp;&nbsp;{{Lang::get('website.nashisot')}}
							</h4>
							<p>&nbsp;</p>
						</div>
					</div>
				...
				<div class="col-xl-5 col-lg-6 order-lg-2 order-1 model_col">
					<div class="model_slider_container_right">
						<div class="wow fadeInLeft owl-carousel owl-theme model_slider">
							<picture>
								<source src="images/pcc/11.jpg" type="image/webp">
								<img src="{{asset('frontend/images/pcc/11.jpg')}}" alt="PCC | seo  и ppc">
							</picture>
						</div>
					</div>
				</div>
	...
	<div class="week_model">
		<div class="wow fadeInRight section_title_container d-flex flex-row align-items-center justify-content-end">
			<div class="d-flex flex-row align-items-center justify-content-start">
				<div class="section_title"><h2>{{Lang::get('website.vnutrik')}}<span>.</span></h2></div>
			</div>
		</div>
		<div class="container">
			<div class="row row-eq-height">
				...
				<div class="col-xl-5 col-lg-6 order-lg-1 order-2 model_col">
					<div class="model_slider_container">
						<div class="wow fadeInRight owl-carousel owl-theme model_slider">
							<picture>
								<source src="images/pcc/15.jpg" type="image/webp">
								<img src="{{asset('frontend/images/pcc/15.jpg')}}" alt="PCC | roi">
							</picture>
						</div>
					</div>
				</div>
				<div class="wow fadeInLeft col-lg-6 offset-xl-1 order-lg-2 order-1 padding-top">
					<div class="week_model_content">
						<h3 class="week_model_title">{{Lang::get('website.rasschitivat')}}</h3>
						<div class="week_model_text">
							<h4>
								&nbsp;&nbsp;&nbsp;&nbsp;{{Lang::get('website.prinsipr')}} 
 
							</h4>
							<h4>
								&nbsp;&nbsp;&nbsp;&nbsp;{{Lang::get('website.etoob')}}
							</h4>
							<h4>&nbsp;&nbsp;&nbsp;&nbsp;{{Lang::get('website.poetomuv')}}.</h4>
							<p>&nbsp;</p>
						</div>
					</div>
				</div>
	...
	<div class="week_model">
		<div class="wow fadeInLeft section_title_container d-flex flex-row align-items-center">
			<div class="d-flex flex-row align-items-center justify-content-start">
				<div class="section_title" style="margin-left: auto;"><h2>{{Lang::get('website.magiyaa')}}<span>.</span></h2></div>
			</div>
		</div>
		<div class="container">
			<div class="row row-eq-height">
				<div class="wow fadeInRight col-lg-6 order-lg-1 order-2 padding_bottom">
					<div class="week_model_content left_uz width_uz">
						<h3 class="week_model_title">{{Lang::get('website.semantiches')}}</h3>
						<div class="week_model_text">
							<h4>&nbsp;&nbsp;&nbsp;&nbsp;{{Lang::get('website.intermar')}}
							</h4>
							<h4>&nbsp;&nbsp;&nbsp;&nbsp;{{Lang::get('website.kreativniy')}}</p>
							<h4>
								&nbsp;&nbsp;&nbsp;&nbsp; {{Lang::get('website.podxodkom')}}
							</h4>
						</div>
					</div>
				</div>
				<div class="col-xl-5 col-lg-6 order-lg-2 order-1 model_col">
					<div class="model_slider_container_right">
						<div class="wow fadeInLeft owl-carousel owl-theme model_slider">
							<picture>
								<source src="images/pcc/16.jpg" type="image/webp">
								<img src="{{asset('frontend/images/pcc/16.jpg')}}" alt="PCC | ads реклама в ташкенте">
							</picture>
						</div>
					</div>
				</div>
			...
			<div class="row row-eq-height">
				...
				<div class="col-xl-5 col-lg-6 order-lg-1 order-2 model_col">
					<div class="model_slider_container">
						<div class="wow fadeInRight owl-carousel owl-theme model_slider">
							<picture>
								<source src="images/pcc/14.jpg" type="image/webp">
								<img src="{{asset('frontend/images/pcc/14.jpg')}}" alt="PCC | прайс">
							</picture>
						</div>
					</div>
				</div>
				<div class="wow fadeInLeft col-lg-6 offset-xl-1 order-lg-2 order-1 padding-top">
					<div class="week_model_content">
						...
						<h3 class="week_model_title">{{Lang::get('website.kontekstnaya')}}</h3>
						<div class="week_model_text">
							<table class="table">
								<tbody>
									<tr>
									...
									<tr>
										<td>Google Ads + Яндекс Директ</td>
										<td>10</td>
										<td>от 150 у.е</td>
									</tr>
									<tr>
										<td>Яндекс и Google Ведение</td>
										<td>10</td>
										<td>от 100 у.е</td>
									</tr>
								</tbody>
