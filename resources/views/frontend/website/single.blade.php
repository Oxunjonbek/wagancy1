...
<title>{{Lang::get('post.primerrabot')}}</title>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="author" content="Web Digital">
<meta name="description" content="С 2014 года мы помогаем узбекским компаниям процветать благодаря веб-сайту, брендингу и дизайну. Наша работа неизменно превосходна, экономична и своевременна.">
<meta name="keywords" content="проекты, работы, дизайн проект, Ташкент, Узбекистан">
...
<link rel="stylesheet" type="text/css" href="{{asset('frontend/styles/single.css')}}">
			...
			<div style="position: absolute; width: 100%; height: 100%;">
					...
					<div class="header_content d-flex flex-row align-items-center justify-content-center">
						<div class="logo_container d-flex flex-row align-items-center justify-content-start">
							<div class="wow fadeInLeft logo align-items-center">
								<a style="float: left;" href="{{route('home')}}"><img src="{{asset('frontend/images/logo/1.png')}}" alt="WD | Web Digital"></a>
							</div>
						...
						<nav class="main_nav" style="position: relative; left: 105px; margin-right: 45px;">
							<ul class="d-flex flex-row align-items-start justify-content-start">
								...
								<li class="active"><a href="{{ route('portfolio') }}">{{Lang::get('home.menu3')}}</a></li>
				...
				<div class="social_bar">
					<div class="d-flex flex-row align-items-center justify-content-start">
						<ul class="d-flex flex-row align-items-start justify-content-start">
							<li><a href="https://www.facebook.com/allwebdigitall" target="_blank">Facebook</a></li>
							<li><a href="https://www.instagram.com/allwebdigital" target="_blank">Instagram</a></li>
							<li><a href="https://t.me/allwebdigitall" target="_blank">Telegram</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="container-fluid">
						<section class="box-intro">
							<div class="table-cell">
								<h1 class="box-headline letters rotate-2 header_index">
									<span class="box-words-wrapper">
										<b class="is-visible">UX.</b>
										<b>&nbsp;UI.</b>
										<b>&nbsp;AI.</b>
									</span>
								</h1>
			...
			<div style="position: absolute; width: 100%; top: 100%;">
				<div style="display: inline-block; width: 100%;">
					...
					function get_post_by_id($post_id){
						...
						//$sql = "SELECT * FROM portfoli WHERE id=".$post_id;
						//$result = mysqli_query($condb, $sql);
						//$post = mysqli_fetch_assoc($result);
						$post = App\Portfolio::where('id',$post_id)->first();
						return $post;
					}
					...
					?>
					<div class="model" style="padding-bottom: 0px;">
						<div class="container">
							<div class="row">
								<div class="col-lg-6 order-lg-1 order-2">
									<div class="model_images d-flex flex-row align-items-start justify-content-between flex-wrap">
										<div class="wow fadeInLeft model_image model_image_full">
											<picture>
												<img class="singel-img" src="{{asset('frontend/images/portfoli')}}/<?=$post['img1']?>" alt="<?=$post['title']?>">
											</picture>
										</div>
									</div>
								</div>
								<div class="col-lg-6 order-lg-2 order-1">
									<div class="wow fadeInRight model_content" style="padding-top: 0;">
												...
												<div class="model_list">
													<ul>
														<li class="d-flex flex-row align-items-start justify-content-start">
															<div>{{Lang::get('post.nazvanie')}}</div>
															<div>
														...
														<li class="d-flex flex-row align-items-start justify-content-start">
															<div>{{Lang::get('post.instrument')}}</div>
															<div>
													...
													<br>
													<div class="model_title">{{Lang::get('post.zadacha')}}</div>
													<p>
								...
								<div class="model" style="padding: 0px;">
									<div class="container">
										<div class="row">
											<div class="col-lg-6 order-lg-1 order-2">
												<div class="model_images d-flex flex-row align-items-start justify-content-between flex-wrap">
													<div class="wow fadeInLeft model_image model_image_full">
														<picture>
															<img class="singel-img" src="{{asset('frontend/images/portfoli')}}/<?=$post['img2']?>" alt="<?=$post['title']?>"></div>
														</picture>
													</div>
												</div>
												<div class="col-lg-6 order-lg-2 order-1">
													<div class="wow fadeInRight model_content" style="padding-top: 0px;">
														<div class="model_list_2">
															<div class="model_title">{{Lang::get('post.opisanie')}}</div>
															<ul>
																<li>
									...
									<div class="container">
										<div class="nav-single">
											<div class="prev-uz"><span class="prev"><i class="fa fa-chevron-left"></i><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;&nbsp;{{Lang::get('post.ranee')}}</span></div>
											<div class="next-uz"><span class="next align-items-center">{{Lang::get('post.dalee')}}&nbsp;&nbsp;&nbsp;<i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i></span></div>
										</div>
									</div>
									<br>
									<br>
							...
							<script src="{{asset('frontend/js/single.js')}}"></script>
