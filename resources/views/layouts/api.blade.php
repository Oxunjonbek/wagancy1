  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Adminka <sup>4</sup></div>
      </a>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="{{route('/devadmin')}} ">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span>Devadmin</span></a>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Adminka:</h6>
            <a class="collapse-item" href="{{route('aportfolio.index')}}">Portfolio</a>
            <a class="collapse-item" href="{{route('ablog.index')}}">Blog</a>
          </div>
        </div>
      </li>
       <li class="nav-item">
...
<script src="//cdn.ckeditor.com/4.13.0/full/ckeditor.js"></script>
  ...
  {{-- <script src="{{ asset('backend/asset/ckeditor/ckeditor.js') }}" --}}
  <script src="{{ asset('backend/js/ckeditor/ckeditor.js') }}"
